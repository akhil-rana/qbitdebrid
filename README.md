...
* **AI-Assisted Development:** This project was built with the help of AI-assisted coding agents (Not Vibe Coded). It has not been thoroughly tested in all possible environments and edge cases. Though the oscestratation is completely done by me and every single line of code is heavily reviewed. Please use it at your own discretion.
